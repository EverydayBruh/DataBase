...
-- Получение списка продуктов с общим количеством на складе
...
-- Вывод списка проданных товаров с количеством и суммарной выручкой за последний месяц
...
-- Получение товаров с самой большой наценкой в разрезе поставщиков
